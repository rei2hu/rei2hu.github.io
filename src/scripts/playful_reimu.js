/* eslint-disable no-use-before-define, no-var, vars-on-top, func-names, prefer-template */
(function () {
  fluidParticles();
  ...
  function fluidParticles() {
    ...
    */
      ...
      var canvas_height = resolution * Math.floor(window.innerHeight / resolution); //Needs to be a multiple of the resolution value below.
      var canvas_width = resolution * Math.floor(window.innerWidth / resolution); //This too.
